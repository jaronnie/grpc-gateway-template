...
import (
	...
	"github.com/jaronnie/grpc-gateway-template/internal"
	"github.com/jaronnie/grpc-gateway-template/pkg/booter"
	"github.com/jaronnie/grpc-gateway-template/pkg/logx"
	"github.com/jaronnie/grpc-gateway-template/pkg/version"
	"github.com/jaronnie/grpc-gateway-template/util"
)

var (
	appName      = "jaronnie-private-agent-app" // must be unique
	exitAfterCmd = true
)
